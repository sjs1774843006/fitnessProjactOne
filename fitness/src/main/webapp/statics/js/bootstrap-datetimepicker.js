...
(function(factory){
        ...
        setValue: function () {
            ...
            if (!this.isInput) {
                if (this.component) {
                    ...
                    var aa = $(this.component).parent().parent().parent().children().first().val(formatted);
                }
    ...
    var DPGlobal = {
        ...
        footTemplate: '<tfoot>' +
        '<tr class="datepicker"><th colspan="7" class="today"></th></tr>' +
        '<tr class="datepicker"><th colspan="7" class="clear"></th></tr>' +
        '</tfoot>'
    };
