    ...
    <script>
        $(function(){
            $('#table').bootstrapTable({
                method:'get',//提交方式
                url: 'queryconsumptionlist.do',//提交地址
...
//            删除
            $("#delBtn").click(function(){
                ...
                del("delconsumption.do",arrselections,arrselections[0].consumption_type_id);
            });
