...
//            删除
            $("#delBtn").click(function(){
                ...
                del("delthecoach.do",arrselections,arrselections[0].thecoach_type_id);
            });
