    ...
    <script>
        $(function(){
            $('#table').bootstrapTable({
                method:'get',//提交方式
                url: 'querycommissiondatalist.do',//提交地址
...
//            删除
            $("#delBtn").click(function(){
                ...
                del("delcommissiondata.do",arrselections,arrselections[0].commission_data_id);
            });
